...
This repository contains R scripts that allow to draw metaplots of TPR1 in TPR1-GFP WT and TPR1-GFP eds1 lines for gene sets of interest
...
expected output - lists of genes bound by TPR1-GFP in Col-0 and Col-0 eds1-2

scripts, input and output is in the subdirectory ./TPR1_bound_genes of this repository
...
On the plot "input_norm.pdf" the confidence intervals are absent since the lines are obtained by subtracting RPM values for TPR1-GFP input from RPM values for each gene set as a whole. For proper normalization, one should input-normalize per gene. 
...
"TPR1_WT.bam", "TPR1_WT.bam.bai",

"TPR1_WT_input.bam", "TPR1_WT_input.bam.bai"

"TPR1_eds1.bam", "TPR1_eds1.bam.bai",

"TPR1_eds1_input.bam", "TPR1_eds1_input.bam.bai"

from the Max Planck Digital Library collection accompanying the preprint ~2Gb
